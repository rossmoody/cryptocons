...
export const MoneroBadge = createIcon({
    path: (
        <>
            ...
            ></path>
            <path
                d="M20.3352 17.3583H16.3886V12L12 16.3302L7.61136 12V17.3583H3.66474H3.53845C5.30654 20.1308 8.43225 22 12 22C15.5677 22 18.6934 20.162 20.4615 17.3583H20.3352Z"
                fill="#4C4C4C"
            ></path>
            <path
