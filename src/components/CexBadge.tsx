    ...
    path: (
        <>
            ...
            <g clipPath="url(#CexBadge_a)">
                <path
                    d="M3.98108 8.90833C3.96848 8.9402 3.95662 8.97207 3.94476 9.00468L3.96181 8.99653L3.98108 8.90833Z"
                    fill="black"
                ></path>
                <path
                    d="M11.2223 16.5333H11.3401H11.7196L11.4699 16.1012L11.2223 16.5304V16.5333Z"
                    fill="#19A6F2"
                ></path>
                <path
                    d="M10.8783 17.9758C10.7182 17.9758 10.5596 17.9669 10.4032 17.9513L9.32098 19.8251C9.83163 19.9416 10.3538 20.0003 10.8775 20H13.7186L12.5497 17.9758H10.8783Z"
                    fill="#19A6F2"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M7.92529 17.0135L8.09874 19.427C8.49315 19.5967 8.90229 19.7299 9.32101 19.825L10.4032 17.9512C9.50891 17.863 8.65394 17.5395 7.92529 17.0135Z"
                    fill="#18C2F2"
                ></path>
                <path
                    d="M15.9414 14.6409H11.3399C11.0619 14.6407 10.7868 14.5853 10.5305 14.4778L11.4696 16.104L15.9414 14.6409Z"
                    fill="#18F2F2"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M10.4349 12.0401C10.4384 12.308 10.5476 12.5638 10.7388 12.7516C10.9299 12.9394 11.1875 13.0441 11.4555 13.0429H14.6665L10.6113 11.4626C10.4947 11.6325 10.4331 11.8341 10.4349 12.0401Z"
                    fill="#18F2F2"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M15.2966 20H18.5484V17.9757H16.049L15.2966 20Z"
                    fill="#19DEF3"
                ></path>
                <path
                    d="M16.6235 16.4288L16.5835 16.5363H18.5485V15.4986L18.1564 15.002L16.6235 16.4288Z"
                    fill="#19DEF3"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M3.44293 12.8583C3.49621 13.3926 3.60046 13.9205 3.75425 14.4349L4.6489 12.845L3.44293 12.8583Z"
                    fill="#19D1F3"
                ></path>
                <path
                    d="M5.60084 13.4328L4.64911 12.845L3.75446 14.4349C3.97752 15.1817 4.30571 15.893 4.72916 16.5474L6.4866 15.5178C6.06674 14.8826 5.76655 14.176 5.60084 13.4328Z"
                    fill="#02C1E9"
                ></path>
                <path
                    d="M3.96176 8.99658L3.94471 9.00473C3.58285 9.96183 3.39824 10.9768 3.39991 12C3.39991 12.0897 3.39991 12.1786 3.40436 12.2676L4.64887 12.845L3.96176 8.99658Z"
                    fill="#18A8F2"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M6.48632 15.5179L4.72888 16.5475C5.54259 17.8195 6.71522 18.8216 8.09847 19.4271L7.92502 17.0137C7.35889 16.6063 6.87142 16.0995 6.48632 15.5179Z"
                    fill="#19E0F3"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M16.9006 13.043H17.3868L17.2267 11.0187H15.8428L16.9006 13.043Z"
                    fill="#19DFF3"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M16.4553 7.65417L16.8377 7.9855L16.6472 7.65417H16.4553Z"
                    fill="#19E0F4"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M8.91759 8.354C8.21913 8.80389 7.67012 9.4512 7.34027 10.2137L8.26012 10.5451L8.91759 8.354Z"
                    fill="#18A7F3"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M9.56396 6.20207C9.92681 6.10261 10.2998 6.04491 10.6758 6.03011L9.7122 5.69434L9.55951 6.20207H9.56396Z"
                    fill="#18C9F3"
                ></path>
                <path
                ...
                ></path>
                <path
                    d="M10.6764 6.0302C10.7431 6.0302 10.8106 6.02428 10.878 6.02428H12.5287L10.8336 4C10.3653 4.00256 9.89842 4.05222 9.44006 4.14824L9.71654 5.69369L10.6801 6.02946L10.6764 6.0302Z"
                    fill="#17E6F2"
                ></path>
                <path
