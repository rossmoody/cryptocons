    ...
    path: (
        <>
            ...
            <g clipPath="url(#HuobiGlobalBadge_a)">
                ...
                ></path>
                <path
                    d="M14.9835 10.04C14.9717 10.0282 14.9482 10.0282 14.9246 10.04C14.9246 10.04 14.9246 10.04 14.9129 10.0517C14.8658 10.6051 14.2535 11.806 13.4883 12.9009C10.8864 16.6213 12.3698 18.4108 13.2057 19.3762C13.6884 19.9414 13.2057 19.3762 14.4184 18.7993C14.5126 18.7522 16.773 17.5514 17.0203 14.8317C17.2675 12.1827 15.5839 10.5227 14.9835 10.04"
                    fill="#059BDC"
                ></path>
            </g>
            <defs>
