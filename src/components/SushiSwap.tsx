...
export const SushiSwap = createIcon({
    path: (
        <>
            ...
            ></path>
            <path
                d="M5.79269 5.97708C5.79269 5.89355 5.70916 5.81002 5.62563 5.89355C5.5421 5.97708 5.45857 5.97708 5.45857 6.0606C5.5421 6.31119 5.62563 6.47825 5.62563 6.64531C5.62563 6.72884 5.70916 6.81237 5.79269 6.72884C5.87622 6.72884 5.95975 6.64531 5.87622 6.56178C5.87622 6.39472 5.87622 6.22766 5.79269 5.97708Z"
                fill="white"
            ></path>
            <path
                d="M6.21034 7.31353C6.21034 7.23 6.12681 7.14647 6.04328 7.23C5.95975 7.31353 5.95975 7.31353 5.95975 7.39706C6.87857 9.48529 8.79974 11.7406 11.3056 13.4112C11.3892 13.4947 11.4727 13.4112 11.5562 13.4112C11.6397 13.3276 11.5562 13.2441 11.5562 13.1606C8.9668 11.49 7.12916 9.31823 6.21034 7.31353Z"
                fill="white"
            ></path>
            <path
                d="M16.3174 15.4994C16.2338 15.4994 16.1503 15.4994 16.1503 15.5829C16.1503 15.6665 16.1503 15.75 16.2338 15.75C16.4844 15.8335 16.8186 15.9171 17.0691 16.0006C17.1527 16.0006 17.2362 16.0006 17.2362 15.9171C17.2362 15.8335 17.2362 15.75 17.1527 15.75C16.9021 15.6665 16.568 15.5829 16.3174 15.4994Z"
                fill="white"
            ></path>
            <path
