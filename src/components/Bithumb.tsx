...
export const Bithumb = createIcon({
    path: (
        <>
            <path
                d="M5.34936 6.76318H8.16884L5.97661 12.1774C5.97661 12.1774 4.83061 12.1585 4.4802 11.1474C4.38204 10.8472 4.3738 10.5244 4.4565 10.2194L5.34936 6.76318Z"
                fill="#D53127"
            ></path>
            <path
                d="M16.2845 6.87907L12.6993 6.81611L13.5061 4.12916C13.5804 3.88319 13.5967 3.62308 13.5537 3.36961C13.5107 3.11615 13.4095 2.87637 13.2582 2.66946C13.107 2.46254 12.9099 2.29423 12.6827 2.17799C12.4555 2.06174 12.2045 2.00079 11.9499 2H8.67771L4.93669 15.567C4.93669 15.567 3.59616 21.3689 8.67771 21.894C8.67771 21.894 16.7109 23.5523 19.2885 13.7513C19.2885 13.7513 20.649 7.8234 16.2845 6.87907ZM13.8341 13.6078C13.8341 13.6078 13.6907 16.1109 11.8202 16.5503C11.544 16.6204 11.2522 16.5901 10.9959 16.4647C10.7029 16.3136 10.3998 16.0001 10.4073 15.3428C10.4122 15.1528 10.4424 14.9644 10.4971 14.7825L11.1879 12.1774H13.0734C13.0734 12.1774 13.9276 12.4582 13.8341 13.6078Z"
                fill="#F47320"
            ></path>
            <path
