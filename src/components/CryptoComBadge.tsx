...
export const CryptoComBadge = createIcon({
    ...
    path: (
        <>
            ...
            ></path>
            <path
                d="M15.096 6.72968H8.78794L8.05539 9.94479H15.8693L15.096 6.72968ZM9.90712 14.3605V12.2239L8.03504 11.0436L5.91879 12.6105L8.80829 17.6366H9.96816L11.3315 16.3547V15.7239L9.90712 14.3605Z"
                fill="white"
            ></path>
            <path
