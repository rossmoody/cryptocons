...
export const CryptoComBadge = createIcon({
    path: (
        <>
            ...
            ></path>
            <path
                d="M13.9972 10.4331H9.92749L10.599 12.2238L10.3955 14.2383H13.5292L13.3257 12.2238L13.9972 10.4331Z"
                fill="white"
            ></path>
            <path
                d="M15.8693 11.0232L14.0175 12.2238V14.3604L12.6135 15.7237V16.3545L13.9768 17.6162H15.1164L17.9856 12.6104L15.8693 11.0232Z"
                fill="white"
            ></path>
            <defs>
                <linearGradient
